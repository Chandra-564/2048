...
HTMLActuator.prototype.addTile = function (tile) {
    ...
    var closest2Power = Math.pow(2, Math.ceil(Math.log(Math.abs(tile.value)) / Math.log(2)));
    if( tile.value === 0 ) {
      closest2Power = 0
    }
...
HTMLActuator.prototype.updateMoves = function (moves) {
  ...
  var difference = moves - this.moves;
  this.moves = moves;

  this.movesContainer.textContent = this.moves + " move" + (this.moves == 1 ? "" : "s");
};
